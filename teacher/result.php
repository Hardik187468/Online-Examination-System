<?php include("includes/header.php"); 
		...
		echo $class;
		echo $std;
		$query = "SELECT * FROM results WHERE class='$class' AND subject='$subj' AND sid='$std'"; //You don't need a ; like you do in SQL
...
<div class="col-md-3">
<input name="std"    class="chosen-input form-control" type=text placeholder="Input Name">
