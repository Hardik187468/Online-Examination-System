...
<div class="row"><div class="col-xs-6 font-bold">Duration :</div><div class="col-xs-6"><?php echo $_SESSION["min"]; $_SESSION["min"]=$_SESSION["min"]-1; ?><?php echo " minutes"; ?></div></div>
...
<div class="row"><div class="col-xs-6 font-bold">Created By :</div><div class="col-xs-6">OES</div></div>
</div>
</div>
