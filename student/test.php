...
$_SESSION['sec']=0;
		...
		$sql = "INSERT INTO results (tid, tname, sid, marks, class, subject, per, status,date ) VALUES ('$eid', '$tname', '$sid', '0','$class', '$subject', '0','Fail','$date')";
							...
							echo'						
                                ...
                                <div class="panel panel-default" id="ques1">
                                    <div class="panel-heading online-test" role="tab" id="">
                                        ...
                                        mso-ansi-language:EN-US;mso-fareast-language:EN-US;mso-bidi-language:AR-SA" onCopy="return false" >' . $row[0] . ' <b> Hint: </b> ' . $row[6] . '</span> </a>
